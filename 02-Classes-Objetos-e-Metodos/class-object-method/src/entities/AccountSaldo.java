...
public class AccountSaldo {
    ...
    // método que deposita/adiciona apenas uma quantia válida do saldo.
    public void deposit(double depoditAmount) {

        if (depoditAmount > 0.0) // se depositAmount for válido
            balance += depoditAmount; // adiciona ao saldo
    }
